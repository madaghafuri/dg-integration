...
namespace DgIntegration.DgOverrideDeviceService
{
    public class OverrideDeviceService
    {
        ...
        public OverrideDeviceService(UserConnection userConnection, bool isCelcom = false) 
        {
        ...
        public virtual async Task Request()
        {
            ...
            try {
                ...
                var req = await this.httpRequest
                    .SetLogName($"Apple: Override Device")
        ...
        public virtual OverrideDeviceService SetParam(string Json)
        {
			try {
        ...
        public virtual OverrideDeviceService SetParam(Enroll_Request.RequestBulkEnrollDevices Param)
        {
            this.param = Param;
            return this;
        }

        public virtual OverrideDeviceService SetParam(string TransactionNumber, Guid RecordId = default(Guid))
        {
        ...
        protected virtual Enroll_Request.RequestBulkEnrollDevices BuildRequest()
        {
            ...
            esq.Filters.Add(esq.CreateFilterWithParameters(FilterComparisonType.Equal, "DgIsReturn", false));
            esq.Filters.Add(esq.CreateFilterWithParameters(FilterComparisonType.Equal, "DgIsVoid", false));
